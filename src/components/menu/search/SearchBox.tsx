                ...
                <div className={`w-full overflow-y-custom h-screen transition duration-400 linear ${isActive ? 'translate-y-0' : 'translate-y-[70%]'} min-[650px]:translate-y-0 min-[650px]:h-auto min-[650px]:w-[600px] bg-white min-[650px]:rounded-lg pointer-events-auto pt-4 pb-5 px-6`}>
                    ...
                    <div className="w-full flex items-start justify-center flex-col gap-2 mt-5">
                        ...
                        <div className="w-full flex items-center justify-start flex-wrap gap-2">
                            <Link to="/" className="h-[28px] border border-gray-200 rounded-full flex items-center justify-center text-[14px] text-gray-500 px-2 hover:text-theme transition-all">محبوب ترین</Link>
                            <Link to="/" className="h-[28px] border border-gray-200 rounded-full flex items-center justify-center text-[14px] text-gray-500 px-2 hover:text-theme transition-all">جدید ترین</Link>
                            <Link to="/" className="h-[28px] border border-gray-200 rounded-full flex items-center justify-center text-[14px] text-gray-500 px-2 hover:text-theme transition-all">پرفروش ترین</Link>
                        </div>
                    </div>
